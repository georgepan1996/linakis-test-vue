...
export const useProductsStore = defineStore('productsStore', () => {
    ...
    function addToCart (prod) {
        ...
        if(prodAddedIndex > -1) {
            ...
            console.log('addedToCart.value[prodAddedIndex]', addedToCart.value[prodAddedIndex]);
            console.log('prodAdded', prodToAdd);
        } else {
            prodToAdd.quantity = 1;
            console.log('new prod', prodToAdd);
            addedToCart.value.push(prodToAdd);
        }
        console.log('added', addedToCart.value)
    }
